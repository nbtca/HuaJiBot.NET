...
public static partial class ElementSerializer
{
    private static readonly Type[] BuiltinElementTypes =
    {
        ...
        // 修饰元素
        typeof(BoldElement),
        typeof(ItalicElement),
        typeof(UnderlineElement),
        typeof(DeleteElement),
        typeof(SpoilerElement),
        typeof(CodeElement),
        typeof(SuperscriptElement),
        typeof(SubscriptElement),
        // 排版元素
        typeof(BreakElement),
        typeof(ParagraphElement),
        typeof(MessageElement),
        // 元信息元素
        typeof(QuoteElement),
    ...
    private static void AddChildElements(
        IList<Element> parent,
    ...
    public static IEnumerable<Element> Deserialize(
        string content,
        IDictionary<string, Type>? externalElementMap = null
    )
    {
        ...
        foreach (var htmlNode in document.DocumentNode.ChildNodes)
