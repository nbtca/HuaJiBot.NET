...
public static class CommandEnumCache
{
    ...
    /// </summary>
    public static CommandArgumentEnumAttributeBase.EnumInfo[] GetEnumItems<T>() where T : struct, Enum
    {
        var type = typeof(T);
        ...
        foreach (var value in Enum.GetValues<T>())
        {
            ...
            reflectionItems.Add(new CommandArgumentEnumAttributeBase.EnumInfo(key, alias, description, value));
        }
...
public class OptimizedCommandArgumentEnumAttribute<T> : CommandArgumentEnumAttributeBase
    where T : struct, Enum
{
    public OptimizedCommandArgumentEnumAttribute(string description) : base(description) { }
