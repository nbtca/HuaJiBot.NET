...
public class CommandSourceGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(
            ...
            static (spc, source) => Execute(source.Where(s => s != null)!, spc)
        );
    }
    ...
    private static void Execute(
        IEnumerable<ClassDeclarationSyntax> pluginClasses,
    ...
    )
    {
        ...
        var commandMethods = pluginClass
            ...
            .Where(m => m.AttributeLists.Any(al => al.Attributes.Any(a => IsCommandAttribute(a))))
            .ToList();
    ...
    )
    {
        ...
        if (
            ...
            || name == "CommandArgumentStringAttribute"
            || name.EndsWith(".CommandArgumentStringAttribute")
        )
        {
        ...
        if (
            name == "CommandArgumentStringMatch"
            || name == "CommandArgumentStringMatchAttribute"
            || name.EndsWith(".CommandArgumentStringMatchAttribute")
        )
        {
        ...
        if (
            name == "CommandArgumentEnum"
            || name == "CommandArgumentEnumAttribute"
            || name.EndsWith(".CommandArgumentEnumAttribute")
        )
        {
            var description = GetAttributeArgument(attribute, 0) ?? "\"\"";
    ...
    private static bool IsCommandAttribute(AttributeSyntax attribute)
    {
        ...
        return name == "Command"
            ...
            || name.EndsWith(".CommandAttribute");
    }
